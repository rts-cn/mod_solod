...
static void app(freeswitch_Session* session, const char* data);
static switch_status_t api(const char* cmd, freeswitch_Session* session, freeswitch_Stream* stream);
